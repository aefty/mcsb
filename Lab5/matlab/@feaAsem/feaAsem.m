classdef feaAsem
    ...
    methods
        ...
        function this = getExactSolution(this)
            
            this.ExactSolution=zeros(size(this.mesh.Points,1),1);
            
            for i = 1 : size(this.mesh.Points,1)
                
                x = this.mesh.Points(i,1);
                y = this.mesh.Points(i,2);
                z = this.mesh.Points(i,3);
                
                %Equation
                this.ExactSolution(i,1) = eval(this.mesh.SolutionString);
            end
